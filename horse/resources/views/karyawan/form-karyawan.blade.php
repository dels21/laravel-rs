...
<head>
    ...
    <title>Surat Daftar Pemeriksaan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
</head>
<body>
    <div class="container">
        <h1>Surat Daftar Pemeriksaan</h1>
        ...
        <form action="" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="jenisKelaminLaki" name="jenisKelamin" value="L" checked>
                            <label class="form-check-label" for="jenisKelaminLaki">Laki-laki</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="jenisKelaminPerempuan" name="jenisKelamin" value="P">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex">
                            <div class="form-check me-3">
                                <input class="form-check-input" type="radio" id="jenisKelaminPemohonLaki" name="jenisKelaminPemohon" value="LPemohon" checked>
                                <label class="form-check-label" for="jenisKelaminPemohonLaki">Laki-laki</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="jenisKelaminPemohonPerempuan" name="jenisKelaminPemohon" value="PPemohon">
                    ...
                    <div class="mb-3">
                        <label for="Permohonan Hasil" class="form-label">Permohonan Hasil</label> <br>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="hasilKeDokter" name="hasilKeDokter" value="hasilKeDokter" checked>
                                <label class="form-check-label" for="hasilKeDokter">Hasil diserahkan ke dokter</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="hasilKePasien" name="hasilKePasien" value="hasilKePasien">
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="harga" name="harga" min="0" placeholder="Masukkan harga modalitas">
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Harga</label>
                    <input type="number" class="form-control" id="harga" name="harga" min="0" placeholder="Masukkan harga modalitas">
